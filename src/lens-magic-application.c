...
LensMagicApplication *
lens_magic_application_new (const char        *application_id,
...
static void
lens_magic_application_activate (GApplication *app)
{
	GtkWindow *window;
...
static void
lens_magic_application_class_init (LensMagicApplicationClass *klass)
{
...
static void
lens_magic_application_about_action (GSimpleAction *action,
                                     GVariant      *parameter,
                                     gpointer       user_data)
{
...
static void
lens_magic_application_quit_action (GSimpleAction *action,
                                    GVariant      *parameter,
                                    gpointer       user_data)
{
	LensMagicApplication *self = user_data;
...
static void
lens_magic_application_init (LensMagicApplication *self)
{
